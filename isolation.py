...
class Board:
    ...
    def play_isolation(self, time_limit=1000, print_moves=False):
        move_history = []
        ...
        while True:
            ...
            #    print e
            #    pass
            print  self.__active_players_queen__ ,curr_move
            if curr_move is None:
                print self.__active_players_queen__ +" has no legal moves left."
            ...
            # Handle Timeout
            if time_limit and time_left() <= -20000:
                print 'time out'
                return self.__inactive_players_queen__, move_history, \
            ...
            if curr_move not in legal_moves:
                print self.__active_players_queen__ +" made an illegal move."
                return self.__inactive_players_queen__, move_history, \
            ...
            if is_over:
                print self.__inactive_players_queen__ + " was forced off the grid."
